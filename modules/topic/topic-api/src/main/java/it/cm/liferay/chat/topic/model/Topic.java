 ...
 * @see TopicModel
 * @see it.cm.liferay.chat.topic.model.impl.TopicImpl
 * @see it.cm.liferay.chat.topic.model.impl.TopicModelImpl
 * @generated
 */
@ImplementationClassName("it.cm.liferay.chat.topic.model.impl.TopicImpl")
@ProviderType
public interface Topic extends TopicModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link it.cm.liferay.chat.topic.model.impl.TopicImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
