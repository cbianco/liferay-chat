 ...
 * @see TopicUserModel
 * @see it.cm.liferay.chat.topic.service.model.impl.TopicUserImpl
 * @see it.cm.liferay.chat.topic.service.model.impl.TopicUserModelImpl
 * @generated
 */
@ImplementationClassName("it.cm.liferay.chat.topic.service.model.impl.TopicUserImpl")
@ProviderType
public interface TopicUser extends TopicUserModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link it.cm.liferay.chat.topic.service.model.impl.TopicUserImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
