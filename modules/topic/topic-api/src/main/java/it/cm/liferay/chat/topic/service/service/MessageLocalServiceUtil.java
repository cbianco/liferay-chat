 ...
 * {@link it.cm.liferay.chat.topic.service.service.impl.MessageLocalServiceImpl} and is the
 ...
 * @see it.cm.liferay.chat.topic.service.service.base.MessageLocalServiceBaseImpl
 * @see it.cm.liferay.chat.topic.service.service.impl.MessageLocalServiceImpl
 * @generated
 */
@ProviderType
public class MessageLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.cm.liferay.chat.topic.service.service.impl.MessageLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.Message addMessage(
		it.cm.liferay.chat.topic.service.model.Message message) {
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.Message createMessage(
		long messageId) {
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.Message deleteMessage(
		long messageId)
	...
	*/
	...
	public static it.cm.liferay.chat.topic.service.model.Message fetchMessage(
		long messageId) {
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.Message fetchMessageByUuidAndGroupId(
		String uuid, long groupId) {
		return getService().fetchMessageByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a message with the primary key could not be found
	*/
	public static it.cm.liferay.chat.topic.service.model.Message getMessage(
		long messageId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.Message getMessageByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getMessageByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static java.util.List<it.cm.liferay.chat.topic.service.model.Message> getMessages(
		int start, int end) {
	...
	*/
	public static java.util.List<it.cm.liferay.chat.topic.service.model.Message> getMessagesByUuidAndCompanyId(
		String uuid, long companyId) {
		return getService().getMessagesByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static java.util.List<it.cm.liferay.chat.topic.service.model.Message> getMessagesByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<it.cm.liferay.chat.topic.service.model.Message> orderByComparator) {
		return getService()
				   .getMessagesByUuidAndCompanyId(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.Message updateMessage(
		it.cm.liferay.chat.topic.service.model.Message message) {
