 ...
 * @see MessageModel
 * @see it.cm.liferay.chat.topic.service.model.impl.MessageImpl
 * @see it.cm.liferay.chat.topic.service.model.impl.MessageModelImpl
 * @generated
 */
@ImplementationClassName("it.cm.liferay.chat.topic.service.model.impl.MessageImpl")
@ProviderType
public interface Message extends MessageModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link it.cm.liferay.chat.topic.service.model.impl.MessageImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
