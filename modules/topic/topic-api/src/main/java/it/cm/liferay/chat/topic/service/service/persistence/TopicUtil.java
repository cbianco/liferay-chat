...
/**
 * The persistence utility for the topic service. This utility wraps {@link it.cm.liferay.chat.topic.service.service.persistence.impl.TopicPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TopicUtil {
	...
	*/
	public static Topic findByUuid_First(String uuid,
		OrderByComparator<Topic> orderByComparator)
		throws it.cm.liferay.chat.topic.service.exception.NoSuchTopicException {
