 ...
 * {@link it.cm.liferay.chat.topic.service.service.impl.TopicUserLocalServiceImpl} and is the
...
public class TopicUserLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.cm.liferay.chat.topic.service.service.impl.TopicUserLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.TopicUser addTopicUser(
		it.cm.liferay.chat.topic.service.model.TopicUser topicUser) {
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.TopicUser createTopicUser(
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.TopicUser deleteTopicUser(
		it.cm.liferay.chat.topic.service.model.TopicUser topicUser) {
	...
	*/
	...
	public static it.cm.liferay.chat.topic.service.model.TopicUser fetchTopicUser(
		it.cm.liferay.chat.topic.service.service.persistence.TopicUserPK topicUserPK) {
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.TopicUser fetchTopicUserByUuidAndGroupId(
		String uuid, long groupId) {
		return getService().fetchTopicUserByUuidAndGroupId(uuid, groupId);
	}
	...
	* @throws PortalException if a topic user with the primary key could not be found
	*/
	public static it.cm.liferay.chat.topic.service.model.TopicUser getTopicUser(
		it.cm.liferay.chat.topic.service.service.persistence.TopicUserPK topicUserPK)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.TopicUser getTopicUserByUuidAndGroupId(
		String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getTopicUserByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static java.util.List<it.cm.liferay.chat.topic.service.model.TopicUser> getTopicUsers(
		int start, int end) {
	...
	*/
	public static java.util.List<it.cm.liferay.chat.topic.service.model.TopicUser> getTopicUsersByUuidAndCompanyId(
		String uuid, long companyId) {
		return getService().getTopicUsersByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static java.util.List<it.cm.liferay.chat.topic.service.model.TopicUser> getTopicUsersByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<it.cm.liferay.chat.topic.service.model.TopicUser> orderByComparator) {
		return getService()
				   .getTopicUsersByUuidAndCompanyId(uuid, companyId, start,
	...
	*/
	public static it.cm.liferay.chat.topic.service.model.TopicUser updateTopicUser(
		it.cm.liferay.chat.topic.service.model.TopicUser topicUser) {
