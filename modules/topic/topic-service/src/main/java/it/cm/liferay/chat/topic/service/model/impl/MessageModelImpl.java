...
import it.cm.liferay.chat.topic.service.model.MessageModel;
import it.cm.liferay.chat.topic.service.model.MessageSoap;
...
public class MessageModelImpl extends BaseModelImpl<Message>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(topic.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.it.cm.liferay.chat.topic.service.model.Message"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(topic.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.it.cm.liferay.chat.topic.service.model.Message"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(topic.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.it.cm.liferay.chat.topic.service.model.Message"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(topic.service.util.ServiceProps.get(
				"lock.expiration.time.it.cm.liferay.chat.topic.service.model.Message"));
	...
	public Object clone() {
		...
		messageImpl.setTopicId((Topic)getTopicId().clone());
	...
	public String toXmlString() {
		...
		sb.append("it.cm.liferay.chat.topic.service.model.Message");
