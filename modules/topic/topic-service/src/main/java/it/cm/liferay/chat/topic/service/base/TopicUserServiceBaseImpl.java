 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link it.cm.liferay.chat.topic.service.impl.TopicUserServiceImpl}.
 * </p>
 *
...
public abstract class TopicUserServiceBaseImpl extends BaseServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link it.cm.liferay.chat.topic.service.TopicUserServiceUtil} to access the topic user remote service.
	 */
	 ...
	 */
	public it.cm.liferay.chat.topic.service.TopicService getTopicService() {
		return topicService;
	}
	...
	public void setTopicService(
		it.cm.liferay.chat.topic.service.TopicService topicService) {
	...
	@BeanReference(type = it.cm.liferay.chat.topic.service.TopicService.class)
	protected it.cm.liferay.chat.topic.service.TopicService topicService;
